...
float dot2_neon_sfp( const float v0[2], const float v1[2]);
float dot2_neon_hfp( const float v0[2], const float v1[2]);
float dot3_c(const float v0[3], const float v1[3]);
float dot3_neon_sfp(const float v0[3], const float v1[3]);
float dot3_neon_hfp(const float v0[3], const float v1[3]);
float dot4_c(const float v0[4], const float v1[4]);
float dot4_neon_sfp(const float v0[4], const float v1[4]);
float dot4_neon_hfp(const float v0[4], const float v1[4]);

void cross3_c( const float v0[3], const float v1[3], float d[3]);
void cross3_neon_sfp( const float v0[3], const float v1[3], float d[3]);
void cross3_neon_hfp( const float v0[3], const float v1[3], float d[3]);

void normalize2_c(const float v[2], float d[2]);
void normalize2_neon_sfp(const float v[2], float d[2]);
void normalize2_neon_hfp(const float v[2], float d[2]);
void normalize3_c(const float v[3], float d[3]);
void normalize3_neon_sfp(const float v[3], float d[3]);
void normalize3_neon_hfp(const float v[3], float d[3]);
void normalize4_c(const float v[4], float d[4]);
void normalize4_neon_sfp(const float v[4], float d[4]);
void normalize4_neon_hfp(const float v[4], float d[4]);
...
void		matmul2_neon_sfp( const float m0[4], const float m1[4], float d[4]);
void		matmul2_neon_hfp( const float m0[4], const float m1[4], float d[4]);
...
void		matmul3_neon_sfp(const float m0[9], const float m1[9], float d[9]);
void		matmul3_neon_hfp(const float m0[9], const float m1[9], float d[9]);
...
void		matmul4_neon_sfp(const float m0[16], const float m1[16], float d[16]);
void		matmul4_neon_hfp(const float m0[16], const float m1[16], float d[16]);
\
/* 
function:	matvec2
...
void		matvec2_neon_sfp(const float m[4], const float v[2], float d[2]);
void		matvec2_neon_hfp(const float m[4], const float v[2], float d[2]);
...
void		matvec3_neon_sfp(const float m[9], const float v[3], float d[3]);
void		matvec3_neon_hfp(const float m[9], const float v[3], float d[3]);
...
void		matvec4_neon_sfp(const float m[16], const float v[4], float d[4]);
void		matvec4_neon_hfp(const float m[16], const float v[4], float d[4]);
