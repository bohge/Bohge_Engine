...
/*---------------------------------------------------------------------------*/ 
void lua_tinker::dostring(lua_State *L, const char *name,  const char* buff)
{
	lua_tinker::dobuffer(L, name, buff, strlen(buff));
}

/*---------------------------------------------------------------------------*/ 
void lua_tinker::dobuffer(lua_State *L, const char *name,  const char* buff, size_t len)
{
	lua_pushcclosure(L, on_error, 0);
	int errfunc = lua_gettop(L);
