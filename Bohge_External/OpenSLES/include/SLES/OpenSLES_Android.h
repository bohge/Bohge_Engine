...
/*---------------------------------------------------------------------------*/
#if defined(ANDROID) // Hack: Wierd compiler error
	typedef sl_int64_t             SLAint64;           /* 64 bit signed integer */
#else
	typedef __int64             SLAint64;           /* 64 bit signed integer */
#endif
...
SL_API extern SLAPIENTRY const SLInterfaceID SL_IID_ANDROIDEFFECT;
...
SL_API extern SLAPIENTRY const SLInterfaceID SL_IID_ANDROIDEFFECTSEND;
...
SL_API extern SLAPIENTRY const SLInterfaceID SL_IID_ANDROIDEFFECTCAPABILITIES;
...
/*---------------------------------------------------------------------------*/
SL_API extern SLAPIENTRY const SLInterfaceID SL_IID_ANDROIDCONFIGURATION;
...
SL_API extern SLAPIENTRY const SLInterfaceID SL_IID_ANDROIDSIMPLEBUFFERQUEUE;
